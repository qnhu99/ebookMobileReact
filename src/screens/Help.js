  ...
  return (
    ...
    >
      ...
      <Text style={styles.text}>
        ...
        a word. Simply select a word in your book and a menu pops up where you
        can see its translation and listen to its pronunciation. Do note that
        this method is only meant for single words (it has a character limit of
        40) and it might not support pronunciation for some languages.
      </Text>
      <Image source={quickLookup} style={styles.screenshot1} />
      <Text style={styles.heading}>Google Translate</Text>
      <Text style={styles.text}>
        This method is meant for the translation of long pieces of text. It
        involves a two-step process.
      </Text>
      <Text style={styles.text}>
        <Text style={styles.emphasize}>1.</Text> First select the text that you
        want to translate (If quick lookup menu pops up, simply dismiss it)
      </Text>
      <Text style={styles.text}>
